...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN       127 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  25, 20 }, { 190,  20 }, { 190, 180 }, { 25, 180 } }
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH          0.6  // (mm) Initial retract.
