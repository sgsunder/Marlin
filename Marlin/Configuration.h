...
#define STRING_CONFIG_H_AUTHOR "(sgsunder, Ender-3 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 155.91
  #define DEFAULT_bedKi 30.14
  #define DEFAULT_bedKd 537.56
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -54.372, -10.595, -2.38 }  // for "Satsana Customized" CAD
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 2), (Y_MAX_POS - 60), 20 }
